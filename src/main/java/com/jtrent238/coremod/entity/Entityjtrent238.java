package com.jtrent238.coremod.entity;
...
import com.jtrent238.coremod.handlers.TradeHandler;

@SuppressWarnings("unchecked")
public class Entityjtrent238 extends EntityVillager// implements IBossDisplayData, IMerchant, INpc
{
	...
	public void registerRenderers(){
		RenderingRegistry.registerEntityRenderingHandler(Entityjtrent238.class, new RenderLiving(new ModelBiped(), 0){private int jtrent238;
